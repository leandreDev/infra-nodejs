...
import {
  CtxInterpretor,
  HttpAbstractService,
  HttpServiceAdminBase,
  HttpServiceBase,
  IBase,
  IHttpResult,
  MiddleWareConfig,
  UtilsSecu,
} from '@leandredev/utils';
...
export class api_collection_plateform {
  constructor(conf: any) {
    ...
    this.certificat = new HttpServiceBase<Interfaces.Icertificat>({
      url: conf.url + 'collection/certificat/',
      secure: conf.secure,
    });
    this.admin_certificat = new HttpServiceAdminBase<Interfaces.Icertificat>({
      url: conf.url + 'admin/certificat/',
      secure: conf.secure,
    });

    this.rsa = new HttpServiceBase<Interfaces.Irsa>({
      url: conf.url + 'collection/rsa/',
      secure: conf.secure,
    });
    this.admin_rsa = new HttpServiceAdminBase<Interfaces.Irsa>({
      url: conf.url + 'admin/rsa/',
      secure: conf.secure,
    });

    this.oidc_Client = new HttpServiceBase<Interfaces.Ioidc_Client>({
      url: conf.url + 'collection/oidc_Client/',
      secure: conf.secure,
    });
    this.admin_oidc_Client = new HttpServiceAdminBase<Interfaces.Ioidc_Client>({
      url: conf.url + 'admin/oidc_Client/',
      secure: conf.secure,
    });

    this.oidc_account = new HttpServiceBase<Interfaces.Ioidc_account>({
      url: conf.url + 'collection/oidc_account/',
      secure: conf.secure,
    });
    this.admin_oidc_account = new HttpServiceAdminBase<Interfaces.Ioidc_account>(
      { url: conf.url + 'admin/oidc_account/', secure: conf.secure }
    );

    this.service_access = new HttpServiceBase<Interfaces.Iservice_access>({
      url: conf.url + 'collection/service_access/',
      secure: conf.secure,
    });
    this.admin_service_access = new HttpServiceAdminBase<Interfaces.Iservice_access>(
      { url: conf.url + 'admin/service_access/', secure: conf.secure }
    );

    this.protoschema = new HttpServiceBase<Interfaces.Iprotoschema>({
      url: conf.url + 'collection/protoschema/',
      secure: conf.secure,
    });
    this.admin_protoschema = new HttpServiceAdminBase<Interfaces.Iprotoschema>({
      url: conf.url + 'admin/protoschema/',
      secure: conf.secure,
    });

    this.mail = new HttpServiceBase<Interfaces.Imail>({
      url: conf.url + 'collection/mail/',
      secure: conf.secure,
    });
    this.admin_mail = new HttpServiceAdminBase<Interfaces.Imail>({
      url: conf.url + 'admin/mail/',
      secure: conf.secure,
    });

    this.mail_sendgrid = new HttpServiceBase<Interfaces.Imail_sendgrid>({
      url: conf.url + 'collection/mail_sendgrid/',
      secure: conf.secure,
    });
    this.admin_mail_sendgrid = new HttpServiceAdminBase<Interfaces.Imail_sendgrid>(
      { url: conf.url + 'admin/mail_sendgrid/', secure: conf.secure }
    );

    this.service_serviceOrchestrator = new HttpServiceBase<Interfaces.Iservice_serviceOrchestrator>(
      {
        url: conf.url + 'collection/service_serviceOrchestrator/',
        secure: conf.secure,
      }
    );
    this.admin_service_serviceOrchestrator = new HttpServiceAdminBase<Interfaces.Iservice_serviceOrchestrator>(
      {
        url: conf.url + 'admin/service_serviceOrchestrator/',
        secure: conf.secure,
      }
    );

    this._view = new HttpServiceBase<Interfaces.I_view>({
      url: conf.url + 'collection/_view/',
      secure: conf.secure,
    });
    this.admin__view = new HttpServiceAdminBase<Interfaces.I_view>({
      url: conf.url + 'admin/_view/',
      secure: conf.secure,
    });

    this._view_params = new HttpServiceBase<Interfaces.I_view_params>({
      url: conf.url + 'collection/_view_params/',
      secure: conf.secure,
    });
    this.admin__view_params = new HttpServiceAdminBase<Interfaces.I_view_params>(
      { url: conf.url + 'admin/_view_params/', secure: conf.secure }
    );

    this.licence = new HttpServiceBase<Interfaces.Ilicence>({
      url: conf.url + 'collection/licence/',
      secure: conf.secure,
    });
    this.admin_licence = new HttpServiceAdminBase<Interfaces.Ilicence>({
      url: conf.url + 'admin/licence/',
      secure: conf.secure,
    });

    this.licence_temporelle = new HttpServiceBase<Interfaces.Ilicence_temporelle>(
      { url: conf.url + 'collection/licence_temporelle/', secure: conf.secure }
    );
    this.admin_licence_temporelle = new HttpServiceAdminBase<Interfaces.Ilicence_temporelle>(
      { url: conf.url + 'admin/licence_temporelle/', secure: conf.secure }
    );

    this.MultilangSendGridTemplate = new HttpServiceBase<Interfaces.IMultilangSendGridTemplate>(
      {
        url: conf.url + 'collection/MultilangSendGridTemplate/',
        secure: conf.secure,
      }
    );
    this.admin_MultilangSendGridTemplate = new HttpServiceAdminBase<Interfaces.IMultilangSendGridTemplate>(
      {
        url: conf.url + 'admin/MultilangSendGridTemplate/',
        secure: conf.secure,
      }
    );

    this.application = new HttpServiceBase<Interfaces.Iapplication>({
      url: conf.url + 'collection/application/',
      secure: conf.secure,
    });
    this.admin_application = new HttpServiceAdminBase<Interfaces.Iapplication>({
      url: conf.url + 'admin/application/',
      secure: conf.secure,
    });

    this.pack_card = new HttpServiceBase<Interfaces.Ipack_card>({
      url: conf.url + 'collection/pack_card/',
      secure: conf.secure,
    });
    this.admin_pack_card = new HttpServiceAdminBase<Interfaces.Ipack_card>({
      url: conf.url + 'admin/pack_card/',
      secure: conf.secure,
    });

    this.TemplateLodash = new HttpServiceBase<Interfaces.ITemplateLodash>({
      url: conf.url + 'collection/TemplateLodash/',
      secure: conf.secure,
    });
    this.admin_TemplateLodash = new HttpServiceAdminBase<Interfaces.ITemplateLodash>(
      { url: conf.url + 'admin/TemplateLodash/', secure: conf.secure }
    );

    this.end_client = new HttpServiceBase<Interfaces.Iend_client>({
      url: conf.url + 'collection/end_client/',
      secure: conf.secure,
    });
    this.admin_end_client = new HttpServiceAdminBase<Interfaces.Iend_client>({
      url: conf.url + 'admin/end_client/',
      secure: conf.secure,
    });

    this.Request = new HttpServiceBase<Interfaces.IRequest>({
      url: conf.url + 'collection/Request/',
      secure: conf.secure,
    });
    this.admin_Request = new HttpServiceAdminBase<Interfaces.IRequest>({
      url: conf.url + 'admin/Request/',
      secure: conf.secure,
    });

    this.ftpsConfig = new HttpServiceBase<Interfaces.IftpsConfig>({
      url: conf.url + 'collection/ftpsConfig/',
      secure: conf.secure,
    });
    this.admin_ftpsConfig = new HttpServiceAdminBase<Interfaces.IftpsConfig>({
      url: conf.url + 'admin/ftpsConfig/',
      secure: conf.secure,
    });

    this.application_configuration = new HttpServiceBase<Interfaces.Iapplication_configuration>(
      {
        url: conf.url + 'collection/application_configuration/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration = new HttpServiceAdminBase<Interfaces.Iapplication_configuration>(
      {
        url: conf.url + 'admin/application_configuration/',
        secure: conf.secure,
      }
    );

    this.application_configuration_phoneCard = new HttpServiceBase<Interfaces.Iapplication_configuration_phoneCard>(
      {
        url: conf.url + 'collection/application_configuration_phoneCard/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_phoneCard = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_phoneCard>(
      {
        url: conf.url + 'admin/application_configuration_phoneCard/',
        secure: conf.secure,
      }
    );

    this.application_configuration_appCoach = new HttpServiceBase<Interfaces.Iapplication_configuration_appCoach>(
      {
        url: conf.url + 'collection/application_configuration_appCoach/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_appCoach = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_appCoach>(
      {
        url: conf.url + 'admin/application_configuration_appCoach/',
        secure: conf.secure,
      }
    );

    this.application_configuration_super_admin_mongo = new HttpServiceBase<Interfaces.Iapplication_configuration_super_admin_mongo>(
      {
        url:
          conf.url + 'collection/application_configuration_super_admin_mongo/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_super_admin_mongo = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_super_admin_mongo>(
      {
        url: conf.url + 'admin/application_configuration_super_admin_mongo/',
        secure: conf.secure,
      }
    );

    this.application_configuration_antico = new HttpServiceBase<Interfaces.Iapplication_configuration_antico>(
      {
        url: conf.url + 'collection/application_configuration_antico/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_antico = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_antico>(
      {
        url: conf.url + 'admin/application_configuration_antico/',
        secure: conf.secure,
      }
    );

    this.application_configuration_appClient = new HttpServiceBase<Interfaces.Iapplication_configuration_appClient>(
      {
        url: conf.url + 'collection/application_configuration_appClient/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_appClient = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_appClient>(
      {
        url: conf.url + 'admin/application_configuration_appClient/',
        secure: conf.secure,
      }
    );

    this.application_configuration_appApprenant = new HttpServiceBase<Interfaces.Iapplication_configuration_appApprenant>(
      {
        url: conf.url + 'collection/application_configuration_appApprenant/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_appApprenant = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_appApprenant>(
      {
        url: conf.url + 'admin/application_configuration_appApprenant/',
        secure: conf.secure,
      }
    );

    this.AppConf_minds_up_admin = new HttpServiceBase<Interfaces.IAppConf_minds_up_admin>(
      {
        url: conf.url + 'collection/AppConf_minds_up_admin/',
        secure: conf.secure,
      }
    );
    this.admin_AppConf_minds_up_admin = new HttpServiceAdminBase<Interfaces.IAppConf_minds_up_admin>(
      { url: conf.url + 'admin/AppConf_minds_up_admin/', secure: conf.secure }
    );

    this.application_configuration_reportApp = new HttpServiceBase<Interfaces.Iapplication_configuration_reportApp>(
      {
        url: conf.url + 'collection/application_configuration_reportApp/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_reportApp = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_reportApp>(
      {
        url: conf.url + 'admin/application_configuration_reportApp/',
        secure: conf.secure,
      }
    );

    this.application_configuration_celio2020Admin = new HttpServiceBase<Interfaces.Iapplication_configuration_celio2020Admin>(
      {
        url: conf.url + 'collection/application_configuration_celio2020Admin/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_celio2020Admin = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_celio2020Admin>(
      {
        url: conf.url + 'admin/application_configuration_celio2020Admin/',
        secure: conf.secure,
      }
    );

    this.application_configuration_manu_admin = new HttpServiceBase<Interfaces.Iapplication_configuration_manu_admin>(
      {
        url: conf.url + 'collection/application_configuration_manu_admin/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_manu_admin = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_manu_admin>(
      {
        url: conf.url + 'admin/application_configuration_manu_admin/',
        secure: conf.secure,
      }
    );

    this.application_configuration_comptoire_or_admin = new HttpServiceBase<Interfaces.Iapplication_configuration_comptoire_or_admin>(
      {
        url:
          conf.url + 'collection/application_configuration_comptoire_or_admin/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_comptoire_or_admin = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_comptoire_or_admin>(
      {
        url: conf.url + 'admin/application_configuration_comptoire_or_admin/',
        secure: conf.secure,
      }
    );

    this.application_configuration_celiofront = new HttpServiceBase<Interfaces.Iapplication_configuration_celiofront>(
      {
        url: conf.url + 'collection/application_configuration_celiofront/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_celiofront = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_celiofront>(
      {
        url: conf.url + 'admin/application_configuration_celiofront/',
        secure: conf.secure,
      }
    );

    this.application_configuration_celioback = new HttpServiceBase<Interfaces.Iapplication_configuration_celioback>(
      {
        url: conf.url + 'collection/application_configuration_celioback/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_celioback = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_celioback>(
      {
        url: conf.url + 'admin/application_configuration_celioback/',
        secure: conf.secure,
      }
    );

    this.application_configuration_celioadmin = new HttpServiceBase<Interfaces.Iapplication_configuration_celioadmin>(
      {
        url: conf.url + 'collection/application_configuration_celioadmin/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_celioadmin = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_celioadmin>(
      {
        url: conf.url + 'admin/application_configuration_celioadmin/',
        secure: conf.secure,
      }
    );

    this.application_configuration_ferrand = new HttpServiceBase<Interfaces.Iapplication_configuration_ferrand>(
      {
        url: conf.url + 'collection/application_configuration_ferrand/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_ferrand = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_ferrand>(
      {
        url: conf.url + 'admin/application_configuration_ferrand/',
        secure: conf.secure,
      }
    );

    this.application_configuration_celio = new HttpServiceBase<Interfaces.Iapplication_configuration_celio>(
      {
        url: conf.url + 'collection/application_configuration_celio/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_celio = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_celio>(
      {
        url: conf.url + 'admin/application_configuration_celio/',
        secure: conf.secure,
      }
    );

    this.AppConf_minds_up = new HttpServiceBase<Interfaces.IAppConf_minds_up>({
      url: conf.url + 'collection/AppConf_minds_up/',
      secure: conf.secure,
    });
    this.admin_AppConf_minds_up = new HttpServiceAdminBase<Interfaces.IAppConf_minds_up>(
      { url: conf.url + 'admin/AppConf_minds_up/', secure: conf.secure }
    );

    this.application_configuration_petit_moulin = new HttpServiceBase<Interfaces.Iapplication_configuration_petit_moulin>(
      {
        url: conf.url + 'collection/application_configuration_petit_moulin/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_petit_moulin = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_petit_moulin>(
      {
        url: conf.url + 'admin/application_configuration_petit_moulin/',
        secure: conf.secure,
      }
    );

    this.application_configuration_petit_moulin_admin = new HttpServiceBase<Interfaces.Iapplication_configuration_petit_moulin_admin>(
      {
        url:
          conf.url + 'collection/application_configuration_petit_moulin_admin/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_petit_moulin_admin = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_petit_moulin_admin>(
      {
        url: conf.url + 'admin/application_configuration_petit_moulin_admin/',
        secure: conf.secure,
      }
    );

    this.application_configuration_qbp_admin = new HttpServiceBase<Interfaces.Iapplication_configuration_qbp_admin>(
      {
        url: conf.url + 'collection/application_configuration_qbp_admin/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_qbp_admin = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_qbp_admin>(
      {
        url: conf.url + 'admin/application_configuration_qbp_admin/',
        secure: conf.secure,
      }
    );

    this.application_configuration_qbp_admin_seller = new HttpServiceBase<Interfaces.Iapplication_configuration_qbp_admin_seller>(
      {
        url:
          conf.url + 'collection/application_configuration_qbp_admin_seller/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_qbp_admin_seller = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_qbp_admin_seller>(
      {
        url: conf.url + 'admin/application_configuration_qbp_admin_seller/',
        secure: conf.secure,
      }
    );

    this.application_configuration_qbp = new HttpServiceBase<Interfaces.Iapplication_configuration_qbp>(
      {
        url: conf.url + 'collection/application_configuration_qbp/',
        secure: conf.secure,
      }
    );
    this.admin_application_configuration_qbp = new HttpServiceAdminBase<Interfaces.Iapplication_configuration_qbp>(
      {
        url: conf.url + 'admin/application_configuration_qbp/',
        secure: conf.secure,
      }
    );

    this.application_instance = new HttpServiceBase<Interfaces.Iapplication_instance>(
      {
        url: conf.url + 'collection/application_instance/',
        secure: conf.secure,
      }
    );
    this.admin_application_instance = new HttpServiceAdminBase<Interfaces.Iapplication_instance>(
      { url: conf.url + 'admin/application_instance/', secure: conf.secure }
    );

    this.service = new HttpServiceBase<Interfaces.Iservice>({
      url: conf.url + 'collection/service/',
      secure: conf.secure,
    });
    this.admin_service = new HttpServiceAdminBase<Interfaces.Iservice>({
      url: conf.url + 'admin/service/',
      secure: conf.secure,
    });

    this.service_sso = new HttpServiceBase<Interfaces.Iservice_sso>({
      url: conf.url + 'collection/service_sso/',
      secure: conf.secure,
    });
    this.admin_service_sso = new HttpServiceAdminBase<Interfaces.Iservice_sso>({
      url: conf.url + 'admin/service_sso/',
      secure: conf.secure,
    });

    this.service_init = new HttpServiceBase<Interfaces.Iservice_init>({
      url: conf.url + 'collection/service_init/',
      secure: conf.secure,
    });
    this.admin_service_init = new HttpServiceAdminBase<Interfaces.Iservice_init>(
      { url: conf.url + 'admin/service_init/', secure: conf.secure }
    );

    this.service_mailtoinfra = new HttpServiceBase<Interfaces.Iservice_mailtoinfra>(
      { url: conf.url + 'collection/service_mailtoinfra/', secure: conf.secure }
    );
    this.admin_service_mailtoinfra = new HttpServiceAdminBase<Interfaces.Iservice_mailtoinfra>(
      { url: conf.url + 'admin/service_mailtoinfra/', secure: conf.secure }
    );

    this.service_licence_token = new HttpServiceBase<Interfaces.Iservice_licence_token>(
      {
        url: conf.url + 'collection/service_licence_token/',
        secure: conf.secure,
      }
    );
    this.admin_service_licence_token = new HttpServiceAdminBase<Interfaces.Iservice_licence_token>(
      { url: conf.url + 'admin/service_licence_token/', secure: conf.secure }
    );

    this.service_goshabaGateway = new HttpServiceBase<Interfaces.Iservice_goshabaGateway>(
      {
        url: conf.url + 'collection/service_goshabaGateway/',
        secure: conf.secure,
      }
    );
    this.admin_service_goshabaGateway = new HttpServiceAdminBase<Interfaces.Iservice_goshabaGateway>(
      { url: conf.url + 'admin/service_goshabaGateway/', secure: conf.secure }
    );

    this.service_socketIo = new HttpServiceBase<Interfaces.Iservice_socketIo>({
      url: conf.url + 'collection/service_socketIo/',
      secure: conf.secure,
    });
    this.admin_service_socketIo = new HttpServiceAdminBase<Interfaces.Iservice_socketIo>(
      { url: conf.url + 'admin/service_socketIo/', secure: conf.secure }
    );

    this.service_supervision = new HttpServiceBase<Interfaces.Iservice_supervision>(
      { url: conf.url + 'collection/service_supervision/', secure: conf.secure }
    );
    this.admin_service_supervision = new HttpServiceAdminBase<Interfaces.Iservice_supervision>(
      { url: conf.url + 'admin/service_supervision/', secure: conf.secure }
    );

    this.service_configuration = new HttpServiceBase<Interfaces.Iservice_configuration>(
      {
        url: conf.url + 'collection/service_configuration/',
        secure: conf.secure,
      }
    );
    this.admin_service_configuration = new HttpServiceAdminBase<Interfaces.Iservice_configuration>(
      { url: conf.url + 'admin/service_configuration/', secure: conf.secure }
    );

    this.service_nginxConfigurator = new HttpServiceBase<Interfaces.Iservice_nginxConfigurator>(
      {
        url: conf.url + 'collection/service_nginxConfigurator/',
        secure: conf.secure,
      }
    );
    this.admin_service_nginxConfigurator = new HttpServiceAdminBase<Interfaces.Iservice_nginxConfigurator>(
      {
        url: conf.url + 'admin/service_nginxConfigurator/',
        secure: conf.secure,
      }
    );

    this.service_push_notification = new HttpServiceBase<Interfaces.Iservice_push_notification>(
      {
        url: conf.url + 'collection/service_push_notification/',
        secure: conf.secure,
      }
    );
    this.admin_service_push_notification = new HttpServiceAdminBase<Interfaces.Iservice_push_notification>(
      {
        url: conf.url + 'admin/service_push_notification/',
        secure: conf.secure,
      }
    );

    this.service_like = new HttpServiceBase<Interfaces.Iservice_like>({
      url: conf.url + 'collection/service_like/',
      secure: conf.secure,
    });
    this.admin_service_like = new HttpServiceAdminBase<Interfaces.Iservice_like>(
      { url: conf.url + 'admin/service_like/', secure: conf.secure }
    );

    this.service_dumy_fso = new HttpServiceBase<Interfaces.Iservice_dumy_fso>({
      url: conf.url + 'collection/service_dumy_fso/',
      secure: conf.secure,
    });
    this.admin_service_dumy_fso = new HttpServiceAdminBase<Interfaces.Iservice_dumy_fso>(
      { url: conf.url + 'admin/service_dumy_fso/', secure: conf.secure }
    );

    this.service_sendGrid = new HttpServiceBase<Interfaces.Iservice_sendGrid>({
      url: conf.url + 'collection/service_sendGrid/',
      secure: conf.secure,
    });
    this.admin_service_sendGrid = new HttpServiceAdminBase<Interfaces.Iservice_sendGrid>(
      { url: conf.url + 'admin/service_sendGrid/', secure: conf.secure }
    );

    this.service_trainingCoursesService = new HttpServiceBase<Interfaces.Iservice_trainingCoursesService>(
      {
        url: conf.url + 'collection/service_trainingCoursesService/',
        secure: conf.secure,
      }
    );
    this.admin_service_trainingCoursesService = new HttpServiceAdminBase<Interfaces.Iservice_trainingCoursesService>(
      {
        url: conf.url + 'admin/service_trainingCoursesService/',
        secure: conf.secure,
      }
    );

    this.service_orchestrator = new HttpServiceBase<Interfaces.Iservice_orchestrator>(
      {
        url: conf.url + 'collection/service_orchestrator/',
        secure: conf.secure,
      }
    );
    this.admin_service_orchestrator = new HttpServiceAdminBase<Interfaces.Iservice_orchestrator>(
      { url: conf.url + 'admin/service_orchestrator/', secure: conf.secure }
    );

    this.service_socket_io = new HttpServiceBase<Interfaces.Iservice_socket_io>(
      { url: conf.url + 'collection/service_socket_io/', secure: conf.secure }
    );
    this.admin_service_socket_io = new HttpServiceAdminBase<Interfaces.Iservice_socket_io>(
      { url: conf.url + 'admin/service_socket_io/', secure: conf.secure }
    );

    this.service_tutor = new HttpServiceBase<Interfaces.Iservice_tutor>({
      url: conf.url + 'collection/service_tutor/',
      secure: conf.secure,
    });
    this.admin_service_tutor = new HttpServiceAdminBase<Interfaces.Iservice_tutor>(
      { url: conf.url + 'admin/service_tutor/', secure: conf.secure }
    );

    this.service_init_js = new HttpServiceBase<Interfaces.Iservice_init_js>({
      url: conf.url + 'collection/service_init_js/',
      secure: conf.secure,
    });
    this.admin_service_init_js = new HttpServiceAdminBase<Interfaces.Iservice_init_js>(
      { url: conf.url + 'admin/service_init_js/', secure: conf.secure }
    );

    this.service_infra_admin = new HttpServiceBase<Interfaces.Iservice_infra_admin>(
      { url: conf.url + 'collection/service_infra_admin/', secure: conf.secure }
    );
    this.admin_service_infra_admin = new HttpServiceAdminBase<Interfaces.Iservice_infra_admin>(
      { url: conf.url + 'admin/service_infra_admin/', secure: conf.secure }
    );

    this.mailtoinfra2 = new HttpServiceBase<Interfaces.Imailtoinfra2>({
      url: conf.url + 'collection/mailtoinfra2/',
      secure: conf.secure,
    });
    this.admin_mailtoinfra2 = new HttpServiceAdminBase<Interfaces.Imailtoinfra2>(
      { url: conf.url + 'admin/mailtoinfra2/', secure: conf.secure }
    );

    this.service_planned_tasks = new HttpServiceBase<Interfaces.Iservice_planned_tasks>(
      {
        url: conf.url + 'collection/service_planned_tasks/',
        secure: conf.secure,
      }
    );
    this.admin_service_planned_tasks = new HttpServiceAdminBase<Interfaces.Iservice_planned_tasks>(
      { url: conf.url + 'admin/service_planned_tasks/', secure: conf.secure }
    );

    this.Service_scorm_gateway = new HttpServiceBase<Interfaces.IService_scorm_gateway>(
      {
        url: conf.url + 'collection/Service_scorm_gateway/',
        secure: conf.secure,
      }
    );
    this.admin_Service_scorm_gateway = new HttpServiceAdminBase<Interfaces.IService_scorm_gateway>(
      { url: conf.url + 'admin/Service_scorm_gateway/', secure: conf.secure }
    );

    this.service_nginxMultiConfigurator = new HttpServiceBase<Interfaces.Iservice_nginxMultiConfigurator>(
      {
        url: conf.url + 'collection/service_nginxMultiConfigurator/',
        secure: conf.secure,
      }
    );
    this.admin_service_nginxMultiConfigurator = new HttpServiceAdminBase<Interfaces.Iservice_nginxMultiConfigurator>(
      {
        url: conf.url + 'admin/service_nginxMultiConfigurator/',
        secure: conf.secure,
      }
    );

    this.service_client_ftp = new HttpServiceBase<Interfaces.Iservice_client_ftp>(
      { url: conf.url + 'collection/service_client_ftp/', secure: conf.secure }
    );
    this.admin_service_client_ftp = new HttpServiceAdminBase<Interfaces.Iservice_client_ftp>(
      { url: conf.url + 'admin/service_client_ftp/', secure: conf.secure }
    );

    this.service_polo_celio = new HttpServiceBase<Interfaces.Iservice_polo_celio>(
      { url: conf.url + 'collection/service_polo_celio/', secure: conf.secure }
    );
    this.admin_service_polo_celio = new HttpServiceAdminBase<Interfaces.Iservice_polo_celio>(
      { url: conf.url + 'admin/service_polo_celio/', secure: conf.secure }
    );

    this.service_fso = new HttpServiceBase<Interfaces.Iservice_fso>({
      url: conf.url + 'collection/service_fso/',
      secure: conf.secure,
    });
    this.admin_service_fso = new HttpServiceAdminBase<Interfaces.Iservice_fso>({
      url: conf.url + 'admin/service_fso/',
      secure: conf.secure,
    });

    this.service_pdfrip = new HttpServiceBase<Interfaces.Iservice_pdfrip>({
      url: conf.url + 'collection/service_pdfrip/',
      secure: conf.secure,
    });
    this.admin_service_pdfrip = new HttpServiceAdminBase<Interfaces.Iservice_pdfrip>(
      { url: conf.url + 'admin/service_pdfrip/', secure: conf.secure }
    );

    this.service_signin = new HttpServiceBase<Interfaces.Iservice_signin>({
      url: conf.url + 'collection/service_signin/',
      secure: conf.secure,
    });
    this.admin_service_signin = new HttpServiceAdminBase<Interfaces.Iservice_signin>(
      { url: conf.url + 'admin/service_signin/', secure: conf.secure }
    );

    this.service_mindsUp = new HttpServiceBase<Interfaces.Iservice_mindsUp>({
      url: conf.url + 'collection/service_mindsUp/',
      secure: conf.secure,
    });
    this.admin_service_mindsUp = new HttpServiceAdminBase<Interfaces.Iservice_mindsUp>(
      { url: conf.url + 'admin/service_mindsUp/', secure: conf.secure }
    );

    this.service_webAppConf = new HttpServiceBase<Interfaces.Iservice_webAppConf>(
      { url: conf.url + 'collection/service_webAppConf/', secure: conf.secure }
    );
    this.admin_service_webAppConf = new HttpServiceAdminBase<Interfaces.Iservice_webAppConf>(
      { url: conf.url + 'admin/service_webAppConf/', secure: conf.secure }
    );

    this.swagger_conv = new HttpServiceBase<Interfaces.Iswagger_conv>({
      url: conf.url + 'collection/swagger_conv/',
      secure: conf.secure,
    });
    this.admin_swagger_conv = new HttpServiceAdminBase<Interfaces.Iswagger_conv>(
      { url: conf.url + 'admin/swagger_conv/', secure: conf.secure }
    );

    this.service_mongo = new HttpServiceBase<Interfaces.Iservice_mongo>({
      url: conf.url + 'collection/service_mongo/',
      secure: conf.secure,
    });
    this.admin_service_mongo = new HttpServiceAdminBase<Interfaces.Iservice_mongo>(
      { url: conf.url + 'admin/service_mongo/', secure: conf.secure }
    );

    this.service_celio_qcm_admin = new HttpServiceBase<Interfaces.Iservice_celio_qcm_admin>(
      {
        url: conf.url + 'collection/service_celio_qcm_admin/',
        secure: conf.secure,
      }
    );
    this.admin_service_celio_qcm_admin = new HttpServiceAdminBase<Interfaces.Iservice_celio_qcm_admin>(
      { url: conf.url + 'admin/service_celio_qcm_admin/', secure: conf.secure }
    );

    this.service_ferrand = new HttpServiceBase<Interfaces.Iservice_ferrand>({
      url: conf.url + 'collection/service_ferrand/',
      secure: conf.secure,
    });
    this.admin_service_ferrand = new HttpServiceAdminBase<Interfaces.Iservice_ferrand>(
      { url: conf.url + 'admin/service_ferrand/', secure: conf.secure }
    );

    this.service_petit_moulin = new HttpServiceBase<Interfaces.Iservice_petit_moulin>(
      {
        url: conf.url + 'collection/service_petit_moulin/',
        secure: conf.secure,
      }
    );
    this.admin_service_petit_moulin = new HttpServiceAdminBase<Interfaces.Iservice_petit_moulin>(
      { url: conf.url + 'admin/service_petit_moulin/', secure: conf.secure }
    );

    this.service_celio_fid = new HttpServiceBase<Interfaces.Iservice_celio_fid>(
      { url: conf.url + 'collection/service_celio_fid/', secure: conf.secure }
    );
    this.admin_service_celio_fid = new HttpServiceAdminBase<Interfaces.Iservice_celio_fid>(
      { url: conf.url + 'admin/service_celio_fid/', secure: conf.secure }
    );

    this.service_celio_qcm = new HttpServiceBase<Interfaces.Iservice_celio_qcm>(
      { url: conf.url + 'collection/service_celio_qcm/', secure: conf.secure }
    );
    this.admin_service_celio_qcm = new HttpServiceAdminBase<Interfaces.Iservice_celio_qcm>(
      { url: conf.url + 'admin/service_celio_qcm/', secure: conf.secure }
    );

    this.service_comptoireOr = new HttpServiceBase<Interfaces.Iservice_comptoireOr>(
      { url: conf.url + 'collection/service_comptoireOr/', secure: conf.secure }
    );
    this.admin_service_comptoireOr = new HttpServiceAdminBase<Interfaces.Iservice_comptoireOr>(
      { url: conf.url + 'admin/service_comptoireOr/', secure: conf.secure }
    );

    this.service_celio_back_task = new HttpServiceBase<Interfaces.Iservice_celio_back_task>(
      {
        url: conf.url + 'collection/service_celio_back_task/',
        secure: conf.secure,
      }
    );
    this.admin_service_celio_back_task = new HttpServiceAdminBase<Interfaces.Iservice_celio_back_task>(
      { url: conf.url + 'admin/service_celio_back_task/', secure: conf.secure }
    );

    this.service_celio_fid_admin = new HttpServiceBase<Interfaces.Iservice_celio_fid_admin>(
      {
        url: conf.url + 'collection/service_celio_fid_admin/',
        secure: conf.secure,
      }
    );
    this.admin_service_celio_fid_admin = new HttpServiceAdminBase<Interfaces.Iservice_celio_fid_admin>(
      { url: conf.url + 'admin/service_celio_fid_admin/', secure: conf.secure }
    );

    this.service_airport = new HttpServiceBase<Interfaces.Iservice_airport>({
      url: conf.url + 'collection/service_airport/',
      secure: conf.secure,
    });
    this.admin_service_airport = new HttpServiceAdminBase<Interfaces.Iservice_airport>(
      { url: conf.url + 'admin/service_airport/', secure: conf.secure }
    );

    this.QBP_service = new HttpServiceBase<Interfaces.IQBP_service>({
      url: conf.url + 'collection/QBP_service/',
      secure: conf.secure,
    });
    this.admin_QBP_service = new HttpServiceAdminBase<Interfaces.IQBP_service>({
      url: conf.url + 'admin/QBP_service/',
      secure: conf.secure,
    });
  }
...
*/
  ...
  public get(
    query: string = '*',
    headers: any = {}
  ): Promise<IHttpResult<Interfaces.Iend_client>> {
...
*/
  ...
  public get(
    ...
    query: string = '*',
    headers: any = {}
  ): Promise<IHttpResult<Interfaces.Ilicence>> {
    return this.baseGet<Interfaces.Ilicence>(
      this.url + userId.toString() + '/' + query,
      headers
    );
  }
}
...
export class api_view_plateform {
  constructor(public conf: any) {
    this.Client = new api_view_Client({
      url: conf.url + 'views/Client/',
      secure: conf.secure,
    });

    this.UserLicence = new api_view_UserLicence({
      url: conf.url + 'views/UserLicence/',
      secure: conf.secure,
    });
  }
