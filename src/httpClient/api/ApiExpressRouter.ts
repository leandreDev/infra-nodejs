...
var toJsonRes:Function = currentApp.toJsonRes ;
    ...
    var parseBody = (req, res, next) => {
        ...
        router.get('/collection/dcbm_service/*' , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.dcbm_service.get( req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.post('/collection/dcbm_service/*' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.dcbm_service.post(req.body, req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.put('/collection/dcbm_service/*' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.dcbm_service.put(req.body, req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.patch('/collection/dcbm_service' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.dcbm_service.patch(req.body)
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.delete('/collection/dcbm_service/:id' ,  (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.dcbm_service.delete(req.params.id)
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.patch('/admin/dcbm_service/*' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.admin_dcbm_service.patch(req.body, req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.delete('/admin/dcbm_service/*' ,  (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.admin_dcbm_service.delete(req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.get('/collection/application_configuration_dcbm/*' , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.application_configuration_dcbm.get( req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.post('/collection/application_configuration_dcbm/*' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.application_configuration_dcbm.post(req.body, req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.put('/collection/application_configuration_dcbm/*' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.application_configuration_dcbm.put(req.body, req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.patch('/collection/application_configuration_dcbm' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.application_configuration_dcbm.patch(req.body)
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.delete('/collection/application_configuration_dcbm/:id' ,  (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.application_configuration_dcbm.delete(req.params.id)
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.patch('/admin/application_configuration_dcbm/*' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.admin_application_configuration_dcbm.patch(req.body, req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.delete('/admin/application_configuration_dcbm/*' ,  (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.admin_application_configuration_dcbm.delete(req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.get('/collection/application_configuration_dcbm_admin/*' , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.application_configuration_dcbm_admin.get( req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.post('/collection/application_configuration_dcbm_admin/*' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.application_configuration_dcbm_admin.post(req.body, req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.put('/collection/application_configuration_dcbm_admin/*' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.application_configuration_dcbm_admin.put(req.body, req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.patch('/collection/application_configuration_dcbm_admin' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.application_configuration_dcbm_admin.patch(req.body)
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.delete('/collection/application_configuration_dcbm_admin/:id' ,  (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.application_configuration_dcbm_admin.delete(req.params.id)
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.patch('/admin/application_configuration_dcbm_admin/*' , parseBody , (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.admin_application_configuration_dcbm_admin.patch(req.body, req.params[0])
                })
                .then(data => {
                res.send(data);
                })
        ...
        router.delete('/admin/application_configuration_dcbm_admin/*' ,  (req , res)=>{
                Promise.resolve()
                .then(() => {
                return bdd_plateforme.collections.admin_application_configuration_dcbm_admin.delete(req.params[0])
                })
                .then(data => {
                res.send(data);
                })
