...
export interface IPlateforme {
  ...
  collections:{
		...
		dcbm_service: IHttpServiceBase<Interface.Idcbm_service> ;
		admin_dcbm_service: IHttpServiceAdminBase<Interface.Idcbm_service>  ;
		...
		application_configuration_dcbm: IHttpServiceBase<Interface.Iapplication_configuration_dcbm> ;
		admin_application_configuration_dcbm: IHttpServiceAdminBase<Interface.Iapplication_configuration_dcbm>  ;

		 
		 
		application_configuration_dcbm_admin: IHttpServiceBase<Interface.Iapplication_configuration_dcbm_admin> ;
		admin_application_configuration_dcbm_admin: IHttpServiceAdminBase<Interface.Iapplication_configuration_dcbm_admin>  ;
