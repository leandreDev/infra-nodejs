...
*/
  constructor(obj:any={}){
    ...
    public _class:string  = "mongo_expression_or" ;
      ...
      public static create(target:any, path:string=""):Promise<Model_mongo_expression_or>{
        return Model_mongo_expression_or.check(target, true, path).then(()=>{
          return new Model_mongo_expression_or(target) ;
        })
      }
