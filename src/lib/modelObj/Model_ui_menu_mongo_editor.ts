...
*/
  constructor(obj:any={}){
    ...
    public _class:string  = "ui_menu_mongo_editor" ;
        ...
        .then((boolean)=>{
          var promArr:Array<Promise<boolean>> = [Promise.resolve(true)] ;
              ...
              if(target["child"] != null && target["child"] != undefined ){
                  ...
                  target["child"].forEach((_child , index:number)=>{
      ...
      public static create(target:any, path:string=""):Promise<Model_ui_menu_mongo_editor>{
