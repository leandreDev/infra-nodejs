...
*/
export class Model_mongo_expression_nor extends   Model_mongo_expression_logical   implements Interface.Imongo_expression_nor {
...
*/
  constructor(obj:any={}){
    ...
    public _class:string  = "mongo_expression_nor" ;
      ...
      public static create(target:any, path:string=""):Promise<Model_mongo_expression_nor>{
