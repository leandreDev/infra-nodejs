...
/**
  config airport
*/
export class Model_application_configuration_airport_admin extends   Model_application_configuration   implements Interface.Iapplication_configuration_airport_admin {
...
*/
  constructor(obj:any={}){
    ...
    public _class:string  = "application_configuration_airport_admin" ;
