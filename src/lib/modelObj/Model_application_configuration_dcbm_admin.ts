...
*/
export class Model_application_configuration_dcbm_admin extends   Model_application_configuration   implements Interface.Iapplication_configuration_dcbm_admin {
...
*/
  constructor(obj:any={}){
    ...
    public _class:string  = "application_configuration_dcbm_admin" ;
