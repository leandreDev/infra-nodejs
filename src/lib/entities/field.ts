...
*/
export class Entity_field extends  Entity   {
  ...
  static cast(obj:any={} , castChildClass:boolean=false){
    ...
    if((!castChildClass) && obj._class && obj._class != 'field' && ['string','date','number','boolean','htmltexte','subdoc','modelid','password','texte','objectid','object',].indexOf(obj._class)!==-1){
    ...
    Entity.cast(obj, true) 
        ...
        if(obj["humanName"] != undefined){
           ...
           obj["humanName"] = obj["humanName"].toString() ;
...
public static checkhumanName(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static check(target:any, isCompleteObj:boolean=true,  path:string=""):string[]{
        ...
        let res:string[] ;
              ...
              if(target.humanName != null && target.humanName != undefined ){
                ...
                res = Entity_field.checkhumanName(target.humanName , `${path}.humanName`) ;
                if(res && res.length > 0){
                  err = [...err , ...res] ;
                }               
