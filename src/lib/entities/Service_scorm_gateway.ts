...
*/
export class Entity_Service_scorm_gateway extends   Entity_service    {
    ...
    Entity_service.cast(obj , true)
        ...
        if(obj["endClientId"] != undefined){
          ...
          if(_.isString(obj["endClientId"])){
            obj["endClientId"] = new mongo.ObjectId(obj["endClientId"]);
          }else if(obj["endClientId"]._id){
            obj["endClientId"] = new mongo.ObjectId(obj["endClientId"]._id) ;
          }
...
public static checkendClientId(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checktemplateUser(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checktemplateProfileUser(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
