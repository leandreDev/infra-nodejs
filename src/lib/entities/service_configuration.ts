...
*/
export class Entity_service_configuration extends   Entity_service    {
...
public static checksrvUrl(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkserviceCollectionName(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkserviceConfigCollectionName(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
