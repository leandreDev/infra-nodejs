...
*/
export class Entity_R3Mailer extends  Entity   {
    ...
    Entity.cast(obj, true) 
        ...
        if(obj["r3_group_resset_password"] != undefined){
          ...
          if(_.isString(obj["r3_group_resset_password"])){
            obj["r3_group_resset_password"] = new mongo.ObjectId(obj["r3_group_resset_password"]);
          }else if(obj["r3_group_resset_password"]._id){
            obj["r3_group_resset_password"] = new mongo.ObjectId(obj["r3_group_resset_password"]._id) ;
          }
        ...
        if(obj["r3_group_welcome"] != undefined){
          ...
          if(_.isString(obj["r3_group_welcome"])){
            obj["r3_group_welcome"] = new mongo.ObjectId(obj["r3_group_welcome"]);
          }else if(obj["r3_group_welcome"]._id){
            obj["r3_group_welcome"] = new mongo.ObjectId(obj["r3_group_welcome"]._id) ;
          }
        ...
        if(obj["r3_contact_to_user"] != undefined){
          ...
          if(_.isString(obj["r3_contact_to_user"])){
            obj["r3_contact_to_user"] = new mongo.ObjectId(obj["r3_contact_to_user"]);
          }else if(obj["r3_contact_to_user"]._id){
            obj["r3_contact_to_user"] = new mongo.ObjectId(obj["r3_contact_to_user"]._id) ;
          }
        ...
        if(obj["r3_contact_to_r3"] != undefined){
          ...
          if(_.isString(obj["r3_contact_to_r3"])){
            obj["r3_contact_to_r3"] = new mongo.ObjectId(obj["r3_contact_to_r3"]);
          }else if(obj["r3_contact_to_r3"]._id){
            obj["r3_contact_to_r3"] = new mongo.ObjectId(obj["r3_contact_to_r3"]._id) ;
          }
        ...
        if(obj["R3_prescriptor_invitation"] != undefined){
          ...
          if(_.isString(obj["R3_prescriptor_invitation"])){
            obj["R3_prescriptor_invitation"] = new mongo.ObjectId(obj["R3_prescriptor_invitation"]);
          }else if(obj["R3_prescriptor_invitation"]._id){
            obj["R3_prescriptor_invitation"] = new mongo.ObjectId(obj["R3_prescriptor_invitation"]._id) ;
          }
        ...
        if(obj["R3_analisys_end_to_r3_and_partner"] != undefined){
          ...
          if(_.isString(obj["R3_analisys_end_to_r3_and_partner"])){
            obj["R3_analisys_end_to_r3_and_partner"] = new mongo.ObjectId(obj["R3_analisys_end_to_r3_and_partner"]);
          }else if(obj["R3_analisys_end_to_r3_and_partner"]._id){
            obj["R3_analisys_end_to_r3_and_partner"] = new mongo.ObjectId(obj["R3_analisys_end_to_r3_and_partner"]._id) ;
          }
        ...
        if(obj["R3_analisys_end_to_user"] != undefined){
          ...
          if(_.isString(obj["R3_analisys_end_to_user"])){
            obj["R3_analisys_end_to_user"] = new mongo.ObjectId(obj["R3_analisys_end_to_user"]);
          }else if(obj["R3_analisys_end_to_user"]._id){
            obj["R3_analisys_end_to_user"] = new mongo.ObjectId(obj["R3_analisys_end_to_user"]._id) ;
          }
        ...
        if(obj["R3_partner_admin_created"] != undefined){
          ...
          if(_.isString(obj["R3_partner_admin_created"])){
            obj["R3_partner_admin_created"] = new mongo.ObjectId(obj["R3_partner_admin_created"]);
          }else if(obj["R3_partner_admin_created"]._id){
            obj["R3_partner_admin_created"] = new mongo.ObjectId(obj["R3_partner_admin_created"]._id) ;
          }
...
public static checkr3BaseUrl(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkr3SendgridApiUrl(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkr3ContactMail(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkr3_group_resset_password(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkr3_group_welcome(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkr3_contact_to_user(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkr3_contact_to_r3(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkR3_prescriptor_invitation(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkR3_analisys_end_to_r3_and_partner(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkR3_analisys_end_to_user(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkR3_partner_admin_created(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
