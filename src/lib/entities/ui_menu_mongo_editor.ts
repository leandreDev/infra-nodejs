...
*/
export class Entity_ui_menu_mongo_editor extends  Entity   {
...
public static checkicon(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
...
public static checkchild(val:any, path:string =null):string[]{
         if(val == null){
            return null ;
         }
         let res:string[] = [] ;
