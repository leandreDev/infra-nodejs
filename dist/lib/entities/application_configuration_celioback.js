...
exports.Entity_application_configuration_celioback = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  configuration de l appli celio back
*/
class Entity_application_configuration_celioback extends application_configuration_1.Entity_application_configuration {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'application_configuration_celioback' && [].indexOf(obj._class) !== -1) {
