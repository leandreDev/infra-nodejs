...
exports.Entity_application_configuration_dcbm = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  config DCBM
*/
class Entity_application_configuration_dcbm extends application_configuration_1.Entity_application_configuration {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'application_configuration_dcbm' && [].indexOf(obj._class) !== -1) {
    ...
    static check(target, isCompleteObj = true, path = "") {
        ...
        if (target.bddUrl != null && target.bddUrl != undefined) {
            res = Entity_application_configuration_dcbm.checkbddUrl(target.bddUrl, `${path}.bddUrl`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
...
exports.Entity_application_configuration_dcbm = Entity_application_configuration_dcbm;
