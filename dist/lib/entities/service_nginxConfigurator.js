...
exports.Entity_service_nginxConfigurator = void 0;
const Index = require("./Index");
const service_1 = require("./service");
/**
  service_nginxConfigurator
*/
class Entity_service_nginxConfigurator extends service_1.Entity_service {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'service_nginxConfigurator' && ['service_nginxMultiConfigurator',].indexOf(obj._class) !== -1) {
