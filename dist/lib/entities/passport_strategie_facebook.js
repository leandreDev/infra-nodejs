...
exports.Entity_passport_strategie_facebook = void 0;
...
*/
class Entity_passport_strategie_facebook extends passport_strategie_1.Entity_passport_strategie {
    ...
    static checkenableProof(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
