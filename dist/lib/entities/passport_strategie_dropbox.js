...
exports.Entity_passport_strategie_dropbox = void 0;
...
*/
class Entity_passport_strategie_dropbox extends passport_strategie_1.Entity_passport_strategie {
    ...
    static checkapiVersion(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
