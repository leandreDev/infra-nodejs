...
*/
class Entity_oidc_Client extends utils_1.Entity {
    static cast(obj = {}, castChildClass = false) {
        ...
        if (obj["users"] != undefined && obj["users"] != null && _.isArray(obj["users"])) {
            obj["users"].forEach((value) => {
                Index.Entity_user_roles.cast(value);
            });
        }
    ...
    static checkgrant_types(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
        let _enum = ["authorization_code", "refresh_token", "client_credentials", "implicit"];
        if (_enum.indexOf(val) == -1) {
            res.push(`${path} dont match one of authorization_code , refresh_token , client_credentials , implicit`);
        }
        if (res.length === 0) {
            return null;
        }
    ...
    static checkredirect_uris(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkresponse_types(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkapplication_type(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkcontacts(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkclient_name(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checklogo_uri(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkclient_uri(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkpolicy_uri(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checktos_uri(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkjwks_uri(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkjwks(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checksector_identifier_uri(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checksubject_type(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkid_token_signed_response_alg(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkid_token_encrypted_response_alg(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkid_token_encrypted_response_enc(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkuserinfo_signed_response_alg(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkuserinfo_encrypted_response_alg(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkuserinfo_encrypted_response_enc(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkrequest_object_signing_alg(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkrequest_object_encryption_alg(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkrequest_object_encryption_enc(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checktoken_endpoint_auth_method(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checktoken_endpoint_auth_signing_alg(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkdefault_max_age(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkrequire_auth_time(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkdefault_acr_values(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkinitiate_login_uri(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkrequest_uris(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkusers(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
        ...
        if (val._class) {
            ...
            result = Index.Entity_user_roles.check(val, false, path);
            //5915c716d25f1bf35b4cb4ae
        }
        res = [...res, ...result];
        if (res.length === 0) {
            return null;
    ...
    static checkpost_logout_redirect_uris(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkpassportConfig(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkuserManagment(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static check(target, isCompleteObj = true, path = "") {
        ...
        if (target.users != null && target.users != undefined) {
            target.users.forEach((data, index) => {
                res = Entity_oidc_Client.checkusers(target.users[index], `${path}.users.${index}`);
                if (res && res.length > 0) {
                    err = [...err, ...res];
                }
            });
        ...
        switch (key) {
            ...
            case 'users':
                ...
                if (value._class) {
                    ...
                    return Index.Entity_user_roles.castQueryParam(subPath, value);
                }
                break;
    ...
    static getClassNameOfProp(path) {
        ...
        switch (key) {
            ...
            case 'request_uris':
                return null;
            case 'users':
                return Index.Entity_user_roles.getClassNameOfProp(subPath);
            case 'post_logout_redirect_uris':
                return null;
            case 'passportConfig':
...
exports.Entity_oidc_Client = Entity_oidc_Client;
//# sourceMappingURL=oidc_Client.js.map