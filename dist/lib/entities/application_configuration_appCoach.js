...
exports.Entity_application_configuration_appCoach = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  c'est la configuration d'une application Coach
*/
class Entity_application_configuration_appCoach extends application_configuration_1.Entity_application_configuration {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'application_configuration_appCoach' && [].indexOf(obj._class) !== -1) {
