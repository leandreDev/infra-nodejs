...
exports.Entity_service_push_notification = void 0;
const Index = require("./Index");
const service_1 = require("./service");
/**
  Service pour gérer les notifications push des applications
*/
class Entity_service_push_notification extends service_1.Entity_service {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'service_push_notification' && [].indexOf(obj._class) !== -1) {
