...
exports.Entity_service_ferrand = void 0;
const Index = require("./Index");
const service_1 = require("./service");
/**
  service ferrand
*/
class Entity_service_ferrand extends service_1.Entity_service {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'service_ferrand' && [].indexOf(obj._class) !== -1) {
    ...
    static check(target, isCompleteObj = true, path = "") {
        ...
        if (target.bddUrl != null && target.bddUrl != undefined) {
            res = Entity_service_ferrand.checkbddUrl(target.bddUrl, `${path}.bddUrl`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
...
exports.Entity_service_ferrand = Entity_service_ferrand;
//# sourceMappingURL=service_ferrand.js.map