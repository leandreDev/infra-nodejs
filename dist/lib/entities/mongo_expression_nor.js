...
exports.Entity_mongo_expression_nor = void 0;
...
*/
class Entity_mongo_expression_nor extends mongo_expression_logical_1.Entity_mongo_expression_logical {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'mongo_expression_nor' && [].indexOf(obj._class) !== -1) {
    ...
    static check(target, isCompleteObj = true, path = "") {
        ...
        if (target.expression != null && target.expression != undefined) {
            target.expression.forEach((data, index) => {
                res = Entity_mongo_expression_nor.checkexpression(target.expression[index], `${path}.expression.${index}`);
                if (res && res.length > 0) {
                    err = [...err, ...res];
                }
            });
...
exports.Entity_mongo_expression_nor = Entity_mongo_expression_nor;
//# sourceMappingURL=mongo_expression_nor.js.map