...
exports.Entity_application_configuration_celioadmin = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  configuration de l appli celio admin
*/
class Entity_application_configuration_celioadmin extends application_configuration_1.Entity_application_configuration {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'application_configuration_celioadmin' && [].indexOf(obj._class) !== -1) {
...
exports.Entity_application_configuration_celioadmin = Entity_application_configuration_celioadmin;
//# sourceMappingURL=application_configuration_celioadmin.js.map