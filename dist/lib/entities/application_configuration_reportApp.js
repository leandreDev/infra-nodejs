...
exports.Entity_application_configuration_reportApp = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  configuration d'un app template
*/
class Entity_application_configuration_reportApp extends application_configuration_1.Entity_application_configuration {
