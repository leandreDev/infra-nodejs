...
exports.Entity_application_configuration_boisdor = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  config boisdor
*/
class Entity_application_configuration_boisdor extends application_configuration_1.Entity_application_configuration {
    ...
    static checkboisdorCustomerApi(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkpayementUrl(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
...
exports.Entity_application_configuration_boisdor = Entity_application_configuration_boisdor;
