...
exports.Entity_application_configuration_petit_moulin = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  conf petit_moulin
*/
class Entity_application_configuration_petit_moulin extends application_configuration_1.Entity_application_configuration {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'application_configuration_petit_moulin' && [].indexOf(obj._class) !== -1) {
