...
exports.Entity_application_configuration_antico = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  configuration d'un parcourt anticoruption
*/
class Entity_application_configuration_antico extends application_configuration_1.Entity_application_configuration {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'application_configuration_antico' && [].indexOf(obj._class) !== -1) {
...
exports.Entity_application_configuration_antico = Entity_application_configuration_antico;
