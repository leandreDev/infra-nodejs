...
exports.Entity_service_airport = void 0;
const Index = require("./Index");
const service_1 = require("./service");
/**
  service airport
*/
class Entity_service_airport extends service_1.Entity_service {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'service_airport' && [].indexOf(obj._class) !== -1) {
    ...
    static check(target, isCompleteObj = true, path = "") {
        ...
        if (target.bddUrl != null && target.bddUrl != undefined) {
            res = Entity_service_airport.checkbddUrl(target.bddUrl, `${path}.bddUrl`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
