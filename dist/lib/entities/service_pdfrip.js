...
exports.Entity_service_pdfrip = void 0;
const Index = require("./Index");
const service_1 = require("./service");
/**
  service de creation de pdf
*/
class Entity_service_pdfrip extends service_1.Entity_service {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'service_pdfrip' && [].indexOf(obj._class) !== -1) {
