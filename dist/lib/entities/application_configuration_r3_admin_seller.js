...
exports.Entity_application_configuration_r3_admin_seller = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  config r3 admin
*/
class Entity_application_configuration_r3_admin_seller extends application_configuration_1.Entity_application_configuration {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'application_configuration_r3_admin_seller' && [].indexOf(obj._class) !== -1) {
    ...
    static check(target, isCompleteObj = true, path = "") {
        ...
        if (target.bddUrl != null && target.bddUrl != undefined) {
            res = Entity_application_configuration_r3_admin_seller.checkbddUrl(target.bddUrl, `${path}.bddUrl`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
        if (target.apiUrl != null && target.apiUrl != undefined) {
            res = Entity_application_configuration_r3_admin_seller.checkapiUrl(target.apiUrl, `${path}.apiUrl`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
        if (target.fsoUrl != null && target.fsoUrl != undefined) {
            res = Entity_application_configuration_r3_admin_seller.checkfsoUrl(target.fsoUrl, `${path}.fsoUrl`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
...
exports.Entity_application_configuration_r3_admin_seller = Entity_application_configuration_r3_admin_seller;
