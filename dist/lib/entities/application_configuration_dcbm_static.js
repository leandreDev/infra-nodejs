...
exports.Entity_application_configuration_dcbm_static = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  dcbm static
*/
class Entity_application_configuration_dcbm_static extends application_configuration_1.Entity_application_configuration {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'application_configuration_dcbm_static' && [].indexOf(obj._class) !== -1) {
...
exports.Entity_application_configuration_dcbm_static = Entity_application_configuration_dcbm_static;
