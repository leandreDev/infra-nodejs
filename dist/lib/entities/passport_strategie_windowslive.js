...
exports.Entity_passport_strategie_windowslive = void 0;
...
*/
class Entity_passport_strategie_windowslive extends passport_strategie_1.Entity_passport_strategie {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'passport_strategie_windowslive' && [].indexOf(obj._class) !== -1) {
    ...
    static check(target, isCompleteObj = true, path = "") {
        ...
        if (target.lib != null && target.lib != undefined) {
            res = Entity_passport_strategie_windowslive.checklib(target.lib, `${path}.lib`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
        ...
        if (target.strategieName != null && target.strategieName != undefined) {
            res = Entity_passport_strategie_windowslive.checkstrategieName(target.strategieName, `${path}.strategieName`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
        ...
        if (target.clientID != null && target.clientID != undefined) {
            res = Entity_passport_strategie_windowslive.checkclientID(target.clientID, `${path}.clientID`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
        ...
        if (target.clientSecret != null && target.clientSecret != undefined) {
            res = Entity_passport_strategie_windowslive.checkclientSecret(target.clientSecret, `${path}.clientSecret`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
        ...
        if (target.callbackURL != null && target.callbackURL != undefined) {
            res = Entity_passport_strategie_windowslive.checkcallbackURL(target.callbackURL, `${path}.callbackURL`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
        if (target.scope != null && target.scope != undefined) {
            res = Entity_passport_strategie_windowslive.checkscope(target.scope, `${path}.scope`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
