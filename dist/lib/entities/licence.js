...
*/
class Entity_licence extends utils_1.Entity {
    ...
    static checkressource(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checklicenceStoreRef(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkcreationDate(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkusingDate(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
...
exports.Entity_licence = Entity_licence;
