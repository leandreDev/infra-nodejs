...
exports.Entity_application_configuration_airport = void 0;
const Index = require("./Index");
const application_configuration_1 = require("./application_configuration");
/**
  config airport
*/
class Entity_application_configuration_airport extends application_configuration_1.Entity_application_configuration {
    static cast(obj = {}, castChildClass = false) {
        if ((!castChildClass) && obj._class && obj._class != 'application_configuration_airport' && [].indexOf(obj._class) !== -1) {
    ...
    static checkairportApi(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static checkairportBddUrl(val, path = null) {
        if (val == null) {
            return null;
        }
        let res = [];
    ...
    static check(target, isCompleteObj = true, path = "") {
        ...
        if (target.airportApi != null && target.airportApi != undefined) {
            res = Entity_application_configuration_airport.checkairportApi(target.airportApi, `${path}.airportApi`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
        if (target.airportBddUrl != null && target.airportBddUrl != undefined) {
            res = Entity_application_configuration_airport.checkairportBddUrl(target.airportBddUrl, `${path}.airportBddUrl`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
        if (target.fsoUrl != null && target.fsoUrl != undefined) {
            res = Entity_application_configuration_airport.checkfsoUrl(target.fsoUrl, `${path}.fsoUrl`);
            if (res && res.length > 0) {
                err = [...err, ...res];
            }
        }
...
exports.Entity_application_configuration_airport = Entity_application_configuration_airport;
