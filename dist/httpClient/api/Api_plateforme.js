...
class api_collection_plateform {
    constructor(conf) {
        ...
        this.swagger_conv = new utils_1.HttpServiceBase({ url: conf.url + "collection/swagger_conv/", secure: conf.secure });
        ...
        this.service_celio_qcm_admin = new utils_1.HttpServiceBase({ url: conf.url + "collection/service_celio_qcm_admin/", secure: conf.secure });
        ...
        this.service_ferrand = new utils_1.HttpServiceBase({ url: conf.url + "collection/service_ferrand/", secure: conf.secure });
        this.admin_service_ferrand = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/service_ferrand/", secure: conf.secure });
        this.service_petit_moulin = new utils_1.HttpServiceBase({ url: conf.url + "collection/service_petit_moulin/", secure: conf.secure });
        ...
        this.service_airport = new utils_1.HttpServiceBase({ url: conf.url + "collection/service_airport/", secure: conf.secure });
        this.admin_service_airport = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/service_airport/", secure: conf.secure });
        this.service_celio_back_task = new utils_1.HttpServiceBase({ url: conf.url + "collection/service_celio_back_task/", secure: conf.secure });
        ...
        this.dpd_dervice = new utils_1.HttpServiceBase({ url: conf.url + "collection/dpd_dervice/", secure: conf.secure });
        this.admin_dpd_dervice = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/dpd_dervice/", secure: conf.secure });
        this.service_celio_fid_admin = new utils_1.HttpServiceBase({ url: conf.url + "collection/service_celio_fid_admin/", secure: conf.secure });
        ...
        this.boisdor_service = new utils_1.HttpServiceBase({ url: conf.url + "collection/boisdor_service/", secure: conf.secure });
        this.admin_boisdor_service = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/boisdor_service/", secure: conf.secure });
        ...
        this.r3_service = new utils_1.HttpServiceBase({ url: conf.url + "collection/r3_service/", secure: conf.secure });
        this.admin_r3_service = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/r3_service/", secure: conf.secure });
        this.dcbm_service = new utils_1.HttpServiceBase({ url: conf.url + "collection/dcbm_service/", secure: conf.secure });
        this.admin_dcbm_service = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/dcbm_service/", secure: conf.secure });
        this.QBP_service = new utils_1.HttpServiceBase({ url: conf.url + "collection/QBP_service/", secure: conf.secure });
        this.admin_QBP_service = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/QBP_service/", secure: conf.secure });
        ...
        this.bois_dor_mailer = new utils_1.HttpServiceBase({ url: conf.url + "collection/bois_dor_mailer/", secure: conf.secure });
        this.admin_bois_dor_mailer = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/bois_dor_mailer/", secure: conf.secure });
        ...
        this.application_configuration_ferrand = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_ferrand/", secure: conf.secure });
        this.admin_application_configuration_ferrand = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_ferrand/", secure: conf.secure });
        this.application_configuration_celio = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_celio/", secure: conf.secure });
        this.admin_application_configuration_celio = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_celio/", secure: conf.secure });
        ...
        this.application_configuration_airport_admin = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_airport_admin/", secure: conf.secure });
        this.admin_application_configuration_airport_admin = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_airport_admin/", secure: conf.secure });
        this.application_configuration_airport = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_airport/", secure: conf.secure });
        this.admin_application_configuration_airport = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_airport/", secure: conf.secure });
        this.application_configuration_boisdor = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_boisdor/", secure: conf.secure });
        this.admin_application_configuration_boisdor = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_boisdor/", secure: conf.secure });
        this.application_configuration_r3 = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_r3/", secure: conf.secure });
        this.admin_application_configuration_r3 = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_r3/", secure: conf.secure });
        this.application_configuration_boisdor_admin_seller = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_boisdor_admin_seller/", secure: conf.secure });
        this.admin_application_configuration_boisdor_admin_seller = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_boisdor_admin_seller/", secure: conf.secure });
        ...
        this.application_configuration_boisdor_admin = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_boisdor_admin/", secure: conf.secure });
        this.admin_application_configuration_boisdor_admin = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_boisdor_admin/", secure: conf.secure });
        ...
        this.application_configuration_r3_admin_seller = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_r3_admin_seller/", secure: conf.secure });
        this.admin_application_configuration_r3_admin_seller = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_r3_admin_seller/", secure: conf.secure });
        this.application_configuration_dcbm_static = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_dcbm_static/", secure: conf.secure });
        this.admin_application_configuration_dcbm_static = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_dcbm_static/", secure: conf.secure });
        this.application_configuration_dcbm = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_dcbm/", secure: conf.secure });
        this.admin_application_configuration_dcbm = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_dcbm/", secure: conf.secure });
        this.application_configuration_dcbm_admin = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_dcbm_admin/", secure: conf.secure });
        this.admin_application_configuration_dcbm_admin = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_dcbm_admin/", secure: conf.secure });
        this.application_configuration_r3_admin = new utils_1.HttpServiceBase({ url: conf.url + "collection/application_configuration_r3_admin/", secure: conf.secure });
        this.admin_application_configuration_r3_admin = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/application_configuration_r3_admin/", secure: conf.secure });
    }
}
