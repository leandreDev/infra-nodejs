...
class api_collection_plateform {
    constructor(conf) {
        ...
        this.service_qcbm = new utils_1.HttpServiceBase({ url: conf.url + "collection/service_qcbm/", secure: conf.secure });
        this.admin_service_qcbm = new utils_1.HttpServiceAdminBase({ url: conf.url + "admin/service_qcbm/", secure: conf.secure });
