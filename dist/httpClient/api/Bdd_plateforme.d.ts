...
export declare class bdd_collection_plateform {
   ...
   */
    ...
    info: vous ne pouvez voir que ce type d'objet
   */
    dcbm_service: HttpServiceBddBase<Interface.Idcbm_service>;
    admin_dcbm_service: HttpServiceBddAdminBase<Interface.Idcbm_service>;
    /**
   ...
   */
    ...
    info: vous ne pouvez voir que ce type d'objet
   */
    application_configuration_dcbm: HttpServiceBddBase<Interface.Iapplication_configuration_dcbm>;
    admin_application_configuration_dcbm: HttpServiceBddAdminBase<Interface.Iapplication_configuration_dcbm>;
    /**
    service d'accès a la sous-collection :application_configuration_dcbm_admin
    desc: configiration de dcbm admin
    info: vous ne pouvez voir que ce type d'objet
   */
    application_configuration_dcbm_admin: HttpServiceBddBase<Interface.Iapplication_configuration_dcbm_admin>;
    admin_application_configuration_dcbm_admin: HttpServiceBddAdminBase<Interface.Iapplication_configuration_dcbm_admin>;
    /**
