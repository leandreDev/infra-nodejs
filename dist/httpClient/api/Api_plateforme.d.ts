import { UtilsSecu, CtxInterpretor, IHttpResult, HttpServiceBase, HttpServiceAdminBase, HttpAbstractService } from "@leandredev/utils";
...
export declare class api_collection_plateform {
   ...
   */
    ...
    info: vous ne pouvez voir que ce type d'objet
   */
    application_configuration_airport_admin: HttpServiceBase<Interfaces.Iapplication_configuration_airport_admin>;
    admin_application_configuration_airport_admin: HttpServiceAdminBase<Interfaces.Iapplication_configuration_airport_admin>;
    /**
    service d'accès a la sous-collection :application_configuration_airport
    desc: config airport
    info: vous ne pouvez voir que ce type d'objet
   */
    application_configuration_airport: HttpServiceBase<Interfaces.Iapplication_configuration_airport>;
    admin_application_configuration_airport: HttpServiceAdminBase<Interfaces.Iapplication_configuration_airport>;
    /**
    service d'accès a la sous-collection :application_configuration_boisdor
    desc: config boisdor
    info: vous ne pouvez voir que ce type d'objet
   */
    application_configuration_boisdor: HttpServiceBase<Interfaces.Iapplication_configuration_boisdor>;
    admin_application_configuration_boisdor: HttpServiceAdminBase<Interfaces.Iapplication_configuration_boisdor>;
    /**
    service d'accès a la sous-collection :application_configuration_r3
    desc: config r3
    info: vous ne pouvez voir que ce type d'objet
   */
    application_configuration_r3: HttpServiceBase<Interfaces.Iapplication_configuration_r3>;
    admin_application_configuration_r3: HttpServiceAdminBase<Interfaces.Iapplication_configuration_r3>;
    /**
    service d'accès a la sous-collection :application_configuration_boisdor_admin_seller
    desc: config boisdor admin
    info: vous ne pouvez voir que ce type d'objet
   */
    application_configuration_boisdor_admin_seller: HttpServiceBase<Interfaces.Iapplication_configuration_boisdor_admin_seller>;
    admin_application_configuration_boisdor_admin_seller: HttpServiceAdminBase<Interfaces.Iapplication_configuration_boisdor_admin_seller>;
    /**
   ...
   */
    ...
    info: vous ne pouvez voir que ce type d'objet
   */
    application_configuration_boisdor_admin: HttpServiceBase<Interfaces.Iapplication_configuration_boisdor_admin>;
    admin_application_configuration_boisdor_admin: HttpServiceAdminBase<Interfaces.Iapplication_configuration_boisdor_admin>;
    /**
