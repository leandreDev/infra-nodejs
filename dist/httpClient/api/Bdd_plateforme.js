...
class bdd_collection_plateform {
    constructor(conf) {
        ...
        this.service_qcbm = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'services', entity: Index.Entity_service_qcbm, _class: 'service_qcbm', debug: conf.debug, collections: this });
        this.admin_service_qcbm = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'services', entity: Index.Entity_service_qcbm, _class: 'service_qcbm', debug: conf.debug });
