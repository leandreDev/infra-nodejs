...
class bdd_collection_plateform {
    constructor(conf) {
        ...
        this.dpd_dervice = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'services', entity: Index.Entity_dpd_dervice, _class: 'dpd_dervice', debug: conf.debug, collections: this });
        this.admin_dpd_dervice = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'services', entity: Index.Entity_dpd_dervice, _class: 'dpd_dervice', debug: conf.debug });
        ...
        this.boisdor_service = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'services', entity: Index.Entity_boisdor_service, _class: 'boisdor_service', debug: conf.debug, collections: this });
        this.admin_boisdor_service = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'services', entity: Index.Entity_boisdor_service, _class: 'boisdor_service', debug: conf.debug });
        ...
        this.r3_service = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'services', entity: Index.Entity_r3_service, _class: 'r3_service', debug: conf.debug, collections: this });
        this.admin_r3_service = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'services', entity: Index.Entity_r3_service, _class: 'r3_service', debug: conf.debug });
        this.dcbm_service = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'services', entity: Index.Entity_dcbm_service, _class: 'dcbm_service', debug: conf.debug, collections: this });
        this.admin_dcbm_service = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'services', entity: Index.Entity_dcbm_service, _class: 'dcbm_service', debug: conf.debug });
        ...
        this.bois_dor_mailer = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'bois_dor_mailers', entity: Index.Entity_bois_dor_mailer, debug: conf.debug, collections: this });
        this.admin_bois_dor_mailer = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'bois_dor_mailers', entity: Index.Entity_bois_dor_mailer, debug: conf.debug });
        ...
        this.application_configuration_airport_admin = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_airport_admin, _class: 'application_configuration_airport_admin', debug: conf.debug, collections: this });
        this.admin_application_configuration_airport_admin = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_airport_admin, _class: 'application_configuration_airport_admin', debug: conf.debug });
        this.application_configuration_airport = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_airport, _class: 'application_configuration_airport', debug: conf.debug, collections: this });
        this.admin_application_configuration_airport = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_airport, _class: 'application_configuration_airport', debug: conf.debug });
        this.application_configuration_boisdor = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_boisdor, _class: 'application_configuration_boisdor', debug: conf.debug, collections: this });
        this.admin_application_configuration_boisdor = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_boisdor, _class: 'application_configuration_boisdor', debug: conf.debug });
        this.application_configuration_r3 = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_r3, _class: 'application_configuration_r3', debug: conf.debug, collections: this });
        this.admin_application_configuration_r3 = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_r3, _class: 'application_configuration_r3', debug: conf.debug });
        this.application_configuration_boisdor_admin_seller = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_boisdor_admin_seller, _class: 'application_configuration_boisdor_admin_seller', debug: conf.debug, collections: this });
        this.admin_application_configuration_boisdor_admin_seller = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_boisdor_admin_seller, _class: 'application_configuration_boisdor_admin_seller', debug: conf.debug });
        ...
        this.application_configuration_boisdor_admin = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_boisdor_admin, _class: 'application_configuration_boisdor_admin', debug: conf.debug, collections: this });
        this.admin_application_configuration_boisdor_admin = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_boisdor_admin, _class: 'application_configuration_boisdor_admin', debug: conf.debug });
        ...
        this.application_configuration_r3_admin_seller = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_r3_admin_seller, _class: 'application_configuration_r3_admin_seller', debug: conf.debug, collections: this });
        this.admin_application_configuration_r3_admin_seller = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_r3_admin_seller, _class: 'application_configuration_r3_admin_seller', debug: conf.debug });
        this.application_configuration_dcbm_static = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_dcbm_static, _class: 'application_configuration_dcbm_static', debug: conf.debug, collections: this });
        this.admin_application_configuration_dcbm_static = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_dcbm_static, _class: 'application_configuration_dcbm_static', debug: conf.debug });
        this.application_configuration_dcbm = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_dcbm, _class: 'application_configuration_dcbm', debug: conf.debug, collections: this });
        this.admin_application_configuration_dcbm = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_dcbm, _class: 'application_configuration_dcbm', debug: conf.debug });
        this.application_configuration_dcbm_admin = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_dcbm_admin, _class: 'application_configuration_dcbm_admin', debug: conf.debug, collections: this });
        this.admin_application_configuration_dcbm_admin = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_dcbm_admin, _class: 'application_configuration_dcbm_admin', debug: conf.debug });
        this.application_configuration_r3_admin = new utils_1.HttpServiceBddBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_r3_admin, _class: 'application_configuration_r3_admin', debug: conf.debug, collections: this });
        this.admin_application_configuration_r3_admin = new utils_1.HttpServiceBddAdminBase({ bdd: conf.bdd, collectionName: 'application_configurations', entity: Index.Entity_application_configuration_r3_admin, _class: 'application_configuration_r3_admin', debug: conf.debug });
    }
